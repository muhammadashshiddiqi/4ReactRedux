...
const kontak = (state = initialState, action) => {
    switch(action.type){
        case GET_LIST_KONTAK:
            console.log("4. Masuk Reducer Getlist Kontak", action);
            return {
                ...state,
        ...
        case ADD_KONTAK:
            console.log("4. Masuk Reducer Add Kontak", action);
            return {
                ...state,
        ...
        case DELETE_KONTAK:
            console.log("4. Masuk Reducer Delete Kontak", action);
            return {
                ...state,
        ...
        case DETAIL_KONTAK :
            console.log("4. Masuk Reducer detail kontak", action);
            return {
                ...state,
        ...
        case UPDATE_KONTAK:
            console.log("4. Masuk Reducer Update Kontak", action);
            return {
                ...state,
